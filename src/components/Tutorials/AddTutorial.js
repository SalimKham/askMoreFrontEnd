 ...
 class AddTutorial extends Component {
    ...
    onSubmit(e){
        ...
        const tutorial = {
            ...
            "allowedGroupes":this.state.allowed_groupes     
        }
        this.props.addTutorial(this.state.subject , tutorial , this.state.file);
    ...
    createGroupeList() {
        console.log(this.state.allowed_groupes)
                                ...
                                <form className="profile-form" onSubmit ={this.onSubmit}>
                                    ...
                                    <div className="input-groupe noWidth" id="content">
                                        ...
                                        <div className="inputs border align-center" id="content-txt" style={{ display: (this.state.show===1 ? "block":"none") }}>
                                            ...
                                            <center>
                                                <textarea name="content"  className="too-big inline" placeholder="content here" value = {this.state.content}
                                                onChange = {this.onChange}
                                                ></textarea>
                                            </center>
                                        </div>
                                    ...
                                    <div className="input-groupe">
                                        ...
                                        <div className="inputs">
                                            ...
                                            <br /><small>important : don't choose any groupe for public </small>
