...
class CommentList extends Component {
    ...
    ShowQuote(list,id){
        console.log("showing quote "+ list.length+"  "+id)
        let item = [];
        if (list.length > 0) {
            list.map(comment => {
                if(comment.id === id){
            ...
            list.map(comment => {
                listItems.push(
                    ...
                    <div class="block comments">
                        <img src={SERVER_URL + comment.user.userInfo.photo + ".min.png"} class="avatar" />
                        <div class="content">
                            <div class="info">
        ...
        return (
            <div>
                ...
                <div class="block add-comments" style={{ width: "100%" }}>
                    <img src={SERVER_URL + this.props.user.userInfo.photo + ".min.png"} />
