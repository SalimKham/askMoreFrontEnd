    ...
    render() {
        return (
            <div class={"wrapper "} style={{ width: "100%" }}>
                ...
                {!this.state.showResult && <table class="table table-striped w-table-fixed" style={{ width: "100%" }}>

                    <thead>
                        <tr style={{ backgroundColor: "#081C23" }}>
                            <th className="text-center text-white" style={{ width: "10%" }}>Question {this.state.currentIndex + 1} :   </th>
                            <th className="text-center text-white" style={{ width: "90%" }}> {this.props.questions[this.state.currentIndex].question} ? </th>
                    ...
                    <tbody>
                        <tr style={{ padding: "0px", backgroundColor: "white" }} >
                            <td  ></td>
                            <td className="font22" > Select Correct Answers :  </td>
                        </tr>
                        {this.showOptions()}
                    </tbody>
